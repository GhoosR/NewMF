    ...
    <form onSubmit={handleSubmit} className="flex items-end space-x-2">
      <div className="flex-1 relative">
        <UserMentionInput
          ...
          className="w-full bg-accent-base/20 rounded-lg px-3 py-1.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-accent-text"
          rows={1}
        />
      </div>
      <div className="flex space-x-2">
        <button
          type="button"
          onClick={onCancel}
          className="px-3 py-1.5 text-xs text-content/60 hover:text-content"
        >
          Cancel
        </button>
        <button
          ...
          className="px-3 py-1.5 text-xs font-medium text-white bg-accent-text rounded-md hover:bg-accent-text/90 disabled:opacity-50"
        >
